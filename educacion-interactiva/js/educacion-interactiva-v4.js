			...
			switch(object.getType())
			{
				...
				case 'flaticon':
					switch(object.getSubType())
					{
						case 'car__001':
						case 'carro__001':
							object.object.innerHTML='<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="'+object.getWidth()+'px" height="'+object.getHeight()+'" viewBox="0 0 112 112" enable-background="new 0 0 112 112" xml:space="preserve">'+
